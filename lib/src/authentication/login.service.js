    ...
    validateToken(token) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const result = yield coneccion_bd.query('SELECT * FROM user_tokens WHERE token = $1', [token]);
                    if (result.rows.length === 0) {
                        return reject({ error: 'Token inválido' });
                    }
                    const decoded = jsonwebtoken_1.default.verify(token, parametros_1.Configuration.codigo);
                    resolve(decoded);
                }
                catch (error) {
                    yield coneccion_bd.query('DELETE FROM user_tokens WHERE token = $1', [token]);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    yield coneccion_bd.query('INSERT INTO user_tokens (user_id, token, expires_at) VALUES ($1, $2, $3)', [user.id, token, expiresAt]);
